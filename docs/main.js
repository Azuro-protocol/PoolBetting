        ...
        function v(e, t, n, i) {
          ...
          return (
            ...
            function (t) {
              ...
              for (t ? h((a = r(e, t))) : (a = []), i = 0; i < n.length; i++) {
                var u;
                if (0 === (u = n[i]).refs) {
    ...
    (() => {
      ...
      function Lt(t, n, r, o, a) {
        ...
        (this.data = t),
          ...
          (this.injections = vt(c.inject, o)),
          (this.slots = function () {
            return u.$slots || gt(t.scopedSlots, (u.$slots = ht(r, o))), u.$slots;
          }),
      ...
      var Ft = {
          ...
          prepatch: function (t, n) {
            ...
            !(function (t, n, r, i, o) {
              ...
              (t.$options._parentListeners = r), Yt(t, r, h), c && ((t.$slots = ht(o, i.context)), t.$forceUpdate());
          ...
          if ((a(n) && (n = p.extend(n)), "function" == typeof n)) {
                    ...
                    a(h) &&
                      (l(h)
                        ...
                        : l(h.component) &&
                          ...
                          r(h.error) && (e.errorComp = Kt(h.error, n)),
                          r(h.loading) &&
                            ((e.loadingComp = Kt(h.loading, n)),
                            0 === h.delay
                              ? (e.loading = !0)
            ...
            if (i(n.options.functional))
              return (function (t, n, i, o, a) {
                ...
                if (f instanceof ve) return Nt(f, i, p.parent, s);
                if (Array.isArray(f)) {
                  for (var d = pt(f) || [], v = new Array(d.length), h = 0; h < d.length; h++)
                    v[h] = Nt(d[h], i, p.parent, s);
                  return v;
                }
              })(n, d, o, s, u);
            var v = o.on;
            ...
            return new ve(
              ...
              void 0,
              s,
              { Ctor: n, propsData: d, listeners: v, tag: c, children: u },
              f
            );
          }
        }
          ...
          (n._uid = Tn++),
            ...
            (function (t) {
              ...
              var n = t.$options,
                ...
                i = r && r.context;
              (t.$slots = ht(n._renderChildren, i)),
                (t.$scopedSlots = e),
            ...
            for (n in u)
              (r = s[n]),
                ...
                r
                  ...
                  : (vr(i, "bind", t, e), i.def && i.def.inserted && c.push(i));
            if (c.length) {
              var p = function () {
          ...
          if (!A || w || "" === w) {
            var O = A && d ? d : c,
              ...
              F = (i._enterCb = M(function () {
                N && (Ri(i, j), Ri(i, S)), F.cancelled ? (N && Ri(i, O), D && D(i)) : R && R(i), (i._enterCb = null);
              }));
            e.data.show ||
              ...
              N &&
                ...
                Ii(i, S),
                Ei(function () {
                  Ri(i, O), F.cancelled || (Ii(i, j), P || (Ui(L) ? setTimeout(F, L) : Mi(i, u, F)));
                })),
          ...
          var s = o.css,
            ...
            x = (i._leaveCb = M(function () {
              i.parentNode && i.parentNode._pending && (i.parentNode._pending[e.key] = null),
                _ && (Ri(i, l), Ri(i, p)),
                x.cancelled ? (_ && Ri(i, c), m && m(i)) : (n(), h && h(i)),
                (i._leaveCb = null);
            }));
          y ? y(C) : C();
        }
        function C() {
          x.cancelled ||
            ...
            _ &&
              ...
              Ii(i, p),
              Ei(function () {
                Ri(i, c), x.cancelled || (Ii(i, l), b || (Ui(w) ? setTimeout(x, w) : Mi(i, u, x)));
              })),
            v && v(i, x),
            _ || b || x());
        }
          ...
          if (
            ...
            r(m)
              ? ((e.elm = e.ns ? c.createElementNS(e.ns, m) : c.createElement(m, e)),
                ...
                v(n, e.elm, o))
              : i(e.isComment)
              ? ((e.elm = c.createComment(e.text)), v(n, e.elm, o))
              : ((e.elm = c.createTextNode(e.text)), v(n, e.elm, o));
          }
        }
        function f(e, t) {
        ...
        function $(e, n, o, a, u, l) {
          if (e !== n) {
            ...
            if (i(e.isAsyncPlaceholder)) r(n.asyncFactory.resolved) ? A(e.elm, n, o) : (n.isAsyncPlaceholder = !0);
              ...
              var d,
                v = n.data;
              r(v) && r((d = v.hook)) && r((d = d.prepatch)) && d(e, n);
              var h = e.children,
                y = n.children;
              if (r(v) && m(n)) {
              ...
              t(n.text)
                    ...
                    (function (e, n, i, o, a) {
                      for (
                        ...
                        t(h)
                          ...
                          ? (m = n[--v])
                          : sr(h, g)
                          ? ($(h, g, o, i, d), (h = n[++f]), (g = i[++d]))
                          : sr(m, b)
                          ? ($(m, b, o, i, y), (m = n[--v]), (b = i[--y]))
                          : sr(h, b)
                          ? ($(h, b, o, i, y),
                            x && c.insertBefore(e, h.elm, c.nextSibling(m.elm)),
                            (h = n[++f]),
                            (b = i[--y]))
                          : sr(m, g)
                          ? ($(m, g, o, i, d), x && c.insertBefore(e, m.elm, h.elm), (m = n[--v]), (g = i[++d]))
                          : (t(s) && (s = ur(n, f, v)),
                            t((u = r(g.key) ? s[g.key] : C(g, n, f, v)))
                              ? p(g, o, e, h.elm, !1, i, d)
                              : sr((l = n[u]), g)
                              ? ($(l, g, o, i, d), (n[u] = void 0), x && c.insertBefore(e, l.elm, h.elm))
                              : p(g, o, e, h.elm, !1, i, d),
                            (g = i[++d]));
                      f > v ? _(e, t(i[y + 1]) ? null : i[y + 1].elm, i, d, y, o) : d > y && w(n, f, v);
                    })(f, h, y, o, l)
                  : r(y)
                ...
                r(v) && r((d = v.hook)) && r((d = d.postpatch)) && d(e, n);
            }
          }
        }
        function T(e, t, n) {
          ...
          if (!t(n)) {
            ...
            if (t(e)) (l = !0), p(n, f);
              ...
              if (!d && sr(e, n)) $(e, n, f, null, null, a);
                ...
                var v = e.elm,
                  h = c.parentNode(v);
                if ((p(n, f, v._leaveCb ? null : h, c.nextSibling(v)), r(n.parent)))
      ...
      function Ki(e, t, n) {
        ...
        if (!i || Array.isArray(r)) {
          for (var o, a, s = 0, u = e.options.length; s < u; s++)
            if (((a = e.options[s]), i)) (o = R(r, Gi(a)) > -1), a.selected !== o && (a.selected = o);
                  ...
                  n.addEventListener(
                    ...
                    (n._moveCb = function e(r) {
                      (r && r.target !== n) ||
                        ...
                        (n.removeEventListener(Ai, e), (n._moveCb = null), Ri(n, t));
                    })
                  );
              }
            }));
      ...
      var ho = { Transition: uo, TransitionGroup: lo };
          ...
          (function (e) {
            ...
            for (t = 0, n = c.length; t < n; t++)
              if (((r = i = c[t].name), (o = c[t].value), Yo.test(r)))
                ...
                Mr(e, r, JSON.stringify(o), c[t]),
                  !e.component && "muted" === r && Go(e.tag, e.attrsMap.type, r) && Rr(e, r, "true", c[t]);
          })(e),
          e
        );
      }
      ...
      function Fa(e) {
        ...
        var t = Ra.test(e.value),
          n = Ea.test(e.value),
          r = Ra.test(e.value.replace(Ia, ""));
        if (e.modifiers) {
          var i = "",
            o = "",
            a = [];
          for (var s in e.modifiers)
            if (Na[s]) (o += Na[s]), Ma[s] && a.push(s);
            else if ("exact" === s) {
              var u = e.modifiers;
              o += La(
                ["ctrl", "shift", "alt", "meta"]
                ...
                if (
                  ...
                  if (e.elseif || e.else)
                    (a = e),
                      ...
                      c && c.if && va(c, { exp: a.elseif, block: a });
                  else {
                    if (e.slotScope) {
                  ...
                  for (
                    ...
                    if (((n = e), r && Do(r))) {
                      ...
                      if (d >= 0) {
                        for (
                          w = e.slice(d);
                          !(Eo.test(w) || So.test(w) || Ro.test(w) || Mo.test(w) || (x = w.indexOf("<", 1)) < 0);
      ...
      var Ds = {
        ...
        render: function (e, t) {
          ...
          if (((o.routerViewDepth = l), p)) {
            var d = c[s],
              v = d && d.component;
            return v ? (d.configProps && Ls(v, o, d.route, d.configProps), a(v, o, r)) : a();
          }
          var h = u.matched[l],
            m = h && h.components[s];
          if (!h || !m) return (c[s] = null), a();
          (c[s] = { component: m }),
        ...
        ou = {
          ...
          render: function (e) {
            var t = this,
              ...
              h = a.redirectedFrom ? As(null, nu(a.redirectedFrom), null, n) : a;
            (u[v] = Is(r, h, this.exactPath)),
              (u[d] =
            ...
            var _ = { class: u },
              b =
                ...
                this.$scopedSlots.default({ href: s, route: a, navigate: y, isActive: u[d], isExactActive: u[v] });
            if (b) {
        ...
        function a(e, n, a) {
          ...
          if (u.path) {
            ...
            for (var d = 0; d < r.length; d++) {
              var v = r[d],
                h = i[v];
              if (du(h.regex, u.path, u.params)) return s(h, u, a);
            }
          }
          return s(null, u);
        }
          ...
          return e && e.redirect
            ? (function (e, n) {
                ...
                if (l) {
                  ...
                  return a({ _normalized: !0, path: tu(v, d), query: p, hash: f }, void 0, n);
                }
                return s(null, n);
              })(e, r || n)
            : e && e.matchAs
      ...
      var vu = uu && window.performance && window.performance.now ? window.performance : Date;
      function hu() {
        return vu.now().toFixed(3);
      }
      var mu = hu();
      function yu() {
        return mu;
      ...
      var Mu = { redirected: 2, aborted: 4, cancelled: 8, duplicated: 16 };
      function Du(e, t) {
        return Lu(
          e,
          t,
      ...
      var kc = sc(
        {
          components: { Member: Cc, MemberSet: Tc.exports, HeaderBar: yc, FooterBar: vc },
          props: { json: { type: Object, default: () => new Object() } },
        },
        lc,
        [],
      ...
      var Ec = sc(
        {
          components: { Branch: jc.exports, FooterBar: vc },
          props: { json: { type: Object, default: () => new Object() } },
          computed: {
            trees: function () {
              let e = {};
      ...
      const Rc = {
        "contracts/TotoBetting.sol:TotoBetting": {
          ...
          events: {
            ...
            "OracleAdded(address)": {
              anonymous: !1,
              inputs: [{ indexed: !0, internalType: "address", name: "newOracle", type: "address" }],
              name: "OracleAdded",
              type: "event",
            },
            "OracleRenounced(address)": {
              anonymous: !1,
              inputs: [{ indexed: !0, internalType: "address", name: "oracle", type: "address" }],
          ...
          methods: {
            ...
            "addOracle(address)": {
              ...
              type: "function",
              params: { oracle_: "new oracle address" },
            ...
            "cancelCondition(uint256)": {
              inputs: [{ internalType: "uint256", name: "oracleConditionID_", type: "uint256" }],
              name: "cancelCondition",
              outputs: [],
              stateMutability: "nonpayable",
              type: "function",
              params: { oracleConditionID_: "the current match or game id in oracle's internal system" },
            ...
            "createCondition(uint256,uint128,uint64[2],uint64,bytes32)": {
              inputs: [
                { internalType: "uint256", name: "oracleConditionID_", type: "uint256" },
                { internalType: "uint128", name: "scopeID_", type: "uint128" },
                { internalType: "uint64[2]", name: "outcomes_", type: "uint64[2]" },
                { internalType: "uint64", name: "timestamp_", type: "uint64" },
                { internalType: "bytes32", name: "ipfsHash_", type: "bytes32" },
              ],
              ...
              type: "function",
              params: {
                ipfsHash_: "detailed info about match stored in IPFS",
                oracleConditionID_: "the current match or game id in oracle's internal system",
                outcomes_: "outcome ids for this condition [outcome 1, outcome 2]",
                scopeID_: "id of the competition or event the condition belongs",
                timestamp_: "time when match starts and bets not allowed",
              },
            ...
            "initialize(address,address,uint128)": {
              inputs: [
                ...
                { internalType: "uint128", name: "fee_", type: "uint128" },
              ],
              name: "initialize",
              outputs: [],
              stateMutability: "nonpayable",
              type: "function",
              params: {
                fee_: "bet fee in decimals 10^9",
                oracle_: "oracle address",
                token_: "address of the token used in bets and rewards",
              },
            },
            ...
            "renounceOracle(address)": {
              inputs: [{ internalType: "address", name: "oracle_", type: "address" }],
              name: "renounceOracle",
              outputs: [],
              stateMutability: "nonpayable",
              type: "function",
              params: { oracle_: "address of oracle to renounce" },
            ...
            "resolveCondition(uint256,uint64)": {
              inputs: [
                { internalType: "uint256", name: "oracleConditionID_", type: "uint256" },
                { internalType: "uint64", name: "outcomeWon_", type: "uint64" },
              ],
              ...
              type: "function",
              params: {
                oracleConditionID_: "the match or game id in oracle's internal system",
                outcomeWon_: "id of happened outcome",
              },
        ...
        "contracts/interface/ITotoBetting.sol:ITotoBetting": {
          source: "contracts/interface/ITotoBetting.sol",
          name: "ITotoBetting",
          events: {
            "BettorWin(address,uint256[],uint256)": {
              anonymous: !1,
      ...
      new ms({
        ...
        router: new oc({
          routes: [
            { path: "/", component: Ic, props: () => ({ json: Rc }) },
            { path: "*", component: Ac, props: (e) => ({ json: Rc[e.path.slice(1)] }) },
          ],
        }),
        mounted() {
