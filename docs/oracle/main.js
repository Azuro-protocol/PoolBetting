    ...
    (() => {
        ...
        if (a(e) && !(e instanceof he))
          return (
            g(e, "__ob__") && e.__ob__ instanceof Te
              ? (n = e.__ob__)
              : xe && !re() && (Array.isArray(e) || u(e)) && Object.isExtensible(e) && !e._isVue && (n = new Te(e)),
            t && n && n.vmCount++,
            n
          );
      }
          ...
          (n._uid = $n++),
            ...
            (function (e) {
              ...
              t.props &&
                ...
                t.methods &&
                  (function (e, t) {
                    for (var n in (e.$options.props, t)) e[n] = "function" != typeof t[n] ? S : $(t[n], e);
                  })(e, t.methods),
                t.data
                  ? (function (e) {
        ...
        var n = (function (e) {
          if (((e = e.trim()), (wr = e.length), e.indexOf("[") < 0 || e.lastIndexOf("]") < wr - 1))
            return (Tr = e.lastIndexOf(".")) > -1
              ...
              : { exp: e, key: null };
          for (xr = e, Tr = $r = kr = 0; !Wr(); ) Kr((Cr = qr())) ? Gr(Cr) : 91 === Cr && Jr(Cr);
          return { exp: e.slice(0, $r), key: e.slice($r + 1, kr) };
        })(e);
        return null === n.key ? e + "=" + t : "$set(" + n.exp + ", " + n.key + ", " + t + ")";
      }
      function qr() {
        return xr.charCodeAt(++Tr);
      }
      function Wr() {
        return Tr >= wr;
      }
      ...
      var li,
        ...
        di = function (e, t, n) {
          ...
          else if (fi.test(n)) e.style.setProperty(T(t), n.replace(fi, ""), "important");
          else {
            var r = vi(t);
      ...
      function Li(e, t) {
        ...
        return (
          t === Ti
            ? a > 0 && ((n = Ti), (l = a), (p = o.length))
            : t === $i
            ? c > 0 && ((n = $i), (l = c), (p = u.length))
            : (p = (n = (l = Math.max(a, c)) > 0 ? (a > c ? Ti : $i) : null) ? (n === Ti ? o.length : u.length) : 0),
          { type: n, timeout: l, propCount: p, hasTransform: n === Ti && Di.test(r[ki + "Property"]) }
        );
      }
      function Ni(e, t) {
                    ...
                    (function (e, n, i, o, a) {
                      for (
                        ...
                        t(v)
                          ...
                          ? (m = n[--h])
                          : sr(v, g)
                          ? (T(v, g, o, i, d), (v = n[++f]), (g = i[++d]))
                          : sr(m, b)
                          ? (T(m, b, o, i, y), (m = n[--h]), (b = i[--y]))
                          : sr(v, b)
                          ? (T(v, b, o, i, y),
                            ...
                            (b = i[--y]))
                          : sr(m, g)
                          ? (T(m, g, o, i, d), x && c.insertBefore(e, m.elm, v.elm), (m = n[--h]), (g = i[++d]))
                          : (t(s) && (s = ur(n, f, h)),
                            t((u = r(g.key) ? s[g.key] : C(g, n, f, h)))
                              ? p(g, o, e, v.elm, !1, i, d)
                              : sr((l = n[u]), g)
                              ? (T(l, g, o, i, d), (n[u] = void 0), x && c.insertBefore(e, l.elm, v.elm))
                              : p(g, o, e, v.elm, !1, i, d),
                            (g = i[++d]));
        ...
        return function (e, n, o, a) {
          if (!t(n)) {
            ...
            if (t(e)) (l = !0), p(n, f);
              ...
              var d = r(e.nodeType);
              if (!d && sr(e, n)) T(e, n, f, null, null, a);
              else {
                if (d) {
                      ...
                      a.sync &&
                        ...
                        u
                          ...
                          : (Pr(e, "update:" + w(r), s, null, !1, 0, c[t]),
                            T(r) !== w(r) && Pr(e, "update:" + T(r), s, null, !1, 0, c[t])))),
                ...
                (function (e, t) {
                  ...
                  function T() {
                    ...
                    if (t) {
                      ...
                      for (C(t[0].length); !(n = e.match(jo)) && (r = e.match(ko) || e.match($o)); )
            ...
            if ("a" === this.tag) (_.on = g), (_.attrs = { href: s, "aria-current": m });
              ...
              if (w) {
                ...
                for (var C in ((x.on = x.on || {}), x.on)) {
                  var T = x.on[C];
                  C in g && (x.on[C] = Array.isArray(T) ? T : [T]);
                }
      ...
      $c.options.__file = "node_modules/hardhat-docgen/src/components/MemberSet.vue";
      var kc = sc(
        {
          components: { Member: Cc, MemberSet: $c.exports, HeaderBar: yc, FooterBar: hc },
          props: { json: { type: Object, default: () => new Object() } },
        },
        lc,
        [],
